...
const translations: Record<string, Partial<Record<Lang, string>>> = {
 ...
 'insurance.cta': { en: 'Start with a simple online appointment.', zh: '從簡單的線上預約開始', ja: 'オンラインで簡単にご予約いただけます。' },
  ...
  // Full FAQ page
  'faqPage.title': { en: 'Dental Coverage & Patient FAQs', zh: '牙科保障與病患常見問題', ja: '保険・診療に関するよくあるご質問' },
  'faqPage.desc': { en: 'Understand your CDCP coverage, children\'s dental benefits, and what to expect before your visit.', zh: '了解您的 CDCP 保障、兒童牙科福利，以及就診前應知事項。', ja: 'CDCPの適用内容、お子様向けの保険、ご来院前に知っておいていただきたい情報をまとめました。' },

  'faqPage.cat1': { en: 'CDCP Annual Renewal', zh: 'CDCP 年度續保', ja: 'CDCPの年次更新について' },
  'faqPage.c1q1': { en: 'Do I need to renew my CDCP coverage every year?', zh: '我每年都要續保 CDCP 嗎？', ja: 'CDCPは毎年更新が必要ですか？' },
  'faqPage.c1a1': { en: 'Yes. CDCP requires annual renewal to remain active.', zh: '是的。CDCP 需要每年續保才能保持有效。', ja: 'はい、CDCPの加入を継続するには毎年の更新手続きが必要です。' },
  'faqPage.c1q2': { en: 'When should I renew my CDCP?', zh: '我應該何時續保 CDCP？', ja: '更新手続きはいつ行えばよいですか？' },
  'faqPage.c1a2': { en: 'Renewal typically begins after tax filing and Notice of Assessment.', zh: '續保通常在報稅及收到評稅通知後開始。', ja: '通常、確定申告後に届く Notice of Assessment（税務評価通知）を受け取った後から手続きが可能になります。' },
  'faqPage.c1q3': { en: 'What happens if I do not renew?', zh: '如果我不續保會怎樣？', ja: '更新をしないとどうなりますか？' },
  'faqPage.c1a3': { en: 'Coverage may become inactive and you may be responsible for costs.', zh: '保障可能變為無效，您可能需要自行承擔費用。', ja: '保険の適用が無効となり、治療費を全額ご負担いただく場合があります。' },
  'faqPage.c1q4': { en: 'How do I renew my CDCP?', zh: '我如何續保 CDCP？', ja: '更新の手続き方法を教えてください。' },
  'faqPage.c1a4': { en: 'You can renew online through the Government of Canada website.', zh: '您可以透過加拿大政府網站線上續保。', ja: 'カナダ政府の公式ウェブサイトからオンラインで更新手続きを行えます。' },

  'faqPage.cat2': { en: 'Check-up Frequency', zh: '檢查頻率', ja: '定期検診の頻度について' },
  'faqPage.c2q1': { en: 'How often are check-ups covered?', zh: '檢查的保障頻率是多少？', ja: '検診はどのくらいの頻度で保険が適用されますか？' },
  'faqPage.c2a1': { en: 'CDCP generally covers one exam per year unless additional visits are approved.', zh: 'CDCP 一般每年保障一次檢查，除非獲批額外就診。', ja: 'CDCPでは原則として年1回の検診が対象となります。追加の検診は事前承認が必要となる場合があります。' },
  'faqPage.c2q2': { en: 'Can I have more than one check-up?', zh: '我可以做多於一次檢查嗎？', ja: '年に複数回の検診は受けられますか？' },
  'faqPage.c2a2': { en: 'Additional visits may be allowed if clinically necessary and approved.', zh: '如臨床有需要並獲批，可允許額外就診。', ja: '臨床的に必要と判断され、承認が得られた場合は追加で受診いただけます。' },

  'faqPage.cat3': { en: 'Children Coverage', zh: '兒童保障', ja: 'お子様の保険について' },
  'faqPage.c3q1': { en: 'Can children use CDCP and other programs?', zh: '兒童可以同時使用 CDCP 與其他計劃嗎？', ja: 'お子様は複数の制度を利用できますか？' },
  'faqPage.c3a1': { en: 'Children may also qualify for Healthy Kids depending on eligibility.', zh: '兒童亦可能視乎資格條件符合 Healthy Kids 計劃。', ja: '対象条件によっては、Healthy Kids 制度も併せてご利用いただける場合があります。' },
  'faqPage.c3q2': { en: 'Can both programs be used together?', zh: '兩個計劃可以同時使用嗎？', ja: '2つの制度を併用することは可能ですか？' },
  'faqPage.c3a2': { en: 'In some cases, yes, depending on program rules.', zh: '在某些情況下可以，視乎計劃規則而定。', ja: '各制度の規定により異なりますが、条件を満たせば併用が可能な場合があります。' },

  'faqPage.cat4': { en: 'Fee Difference', zh: '費用差額', ja: '費用の差額について' },
  'faqPage.c4q1': { en: 'Will my child have out-of-pocket costs?', zh: '我的孩子需要自付費用嗎？', ja: 'お子様の治療で自己負担は発生しますか？' },
  'faqPage.c4a1': { en: 'There may be a fee difference depending on coverage.', zh: '視乎保障情況可能存在費用差額。', ja: '保険の適用範囲により、差額が発生する場合があります。' },
  'faqPage.c4q2': { en: 'Why is there a fee difference?', zh: '為何會有費用差額？', ja: 'なぜ差額が生じるのですか？' },
  'faqPage.c4a2': { en: 'Government programs follow their own fee schedules.', zh: '政府計劃有其本身的收費標準。', ja: '政府の制度は独自の料金基準に基づいて支払われるため、当院の料金との差額が発生する場合があります。' },
  'faqPage.c4q3': { en: 'What are frequency limits?', zh: '什麼是頻率限制？', ja: '回数制限とは何ですか？' },
  'faqPage.c4a3': { en: 'Some services are only covered a limited number of times.', zh: '部分服務只獲限定次數的保障。', ja: '一部の処置は、保険適用となる回数に上限が定められています。' },

  'faqPage.cat5': { en: 'General Coverage', zh: '一般保障', ja: '保険適用全般について' },
  'faqPage.c5q1': { en: 'Does CDCP cover all treatments?', zh: 'CDCP 涵蓋所有治療嗎？', ja: 'CDCPはすべての治療に適用されますか？' },
  'faqPage.c5a1': { en: 'No. Some treatments require approval or are partially covered.', zh: '不會。部分治療需要批核或只獲部分保障。', ja: 'いいえ。事前承認が必要な治療や、一部のみ保険適用となる治療もございます。' },
  'faqPage.c5q2': { en: 'Will I be informed of costs first?', zh: '我會事先被告知費用嗎？', ja: '治療前に費用を知ることはできますか？' },
  'faqPage.c5a2': { en: 'Yes. We explain costs before treatment.', zh: '會的。我們會在治療前說明費用。', ja: 'はい、治療を始める前に費用について丁寧にご説明いたします。' },

  'faqPage.cat6': { en: 'Next Steps', zh: '下一步', ja: '次のステップ' },
  'faqPage.c6q1': { en: 'I am not sure about my coverage. What should I do?', zh: '我不確定自己的保障，該怎麼辦？', ja: '自分の保険内容がよくわからない場合はどうすればよいですか？' },
  'faqPage.c6a1': { en: 'Book an appointment and we will help verify your coverage.', zh: '預約看診，我們會協助核實您的保障。', ja: 'ご予約いただければ、当院にて保険内容の確認をお手伝いいたします。' },
